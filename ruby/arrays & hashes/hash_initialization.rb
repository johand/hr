...
# In this challenge, your task is to create three different Hash collections as
# explained below.
...
# * Initialize an empty Hash with the variable name default_hash and the default
# value of every key set to 1.
...
# Initialize a hash with the variable name hackerrank and having the key-value
# pairs
