...
# The player must avoid the thunderheads. Determine the minimum number of jumps it
# will take to jump from the starting postion to the last cloud. It is always
...
# the player must avoid the clouds at indices 1 and 5. They could follow these two
# paths: 0 -> 2 -> 4 -> 6 or 0 -> 2 -> 3 -> 4 -> 6. The first path takes 3 jumps
...
# line contains n space-separated binary integers describing clouds c[i] where 0
# <= i < n.
...
# The player must avoid c[2] and c[5]. The game can be won with a minimum of 4
# jumps
