...
# used to construct the result of a higher-order function that needs to return a
# function.
...
# In the above example, we can see that lambdas can be called using both .call()
# and .().
...
# * values_only is a lambda that takes a hash and returns an array of hash
#   values.
