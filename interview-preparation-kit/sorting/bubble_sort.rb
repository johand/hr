...
# 2. First Element: firstElement, where firstElement is the firts element in the
# sorted array
...
# The array is not sorted, and its initial values are: {3, 2, 1} The following 3
# swaps take place:
