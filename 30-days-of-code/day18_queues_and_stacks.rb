...
# correctly written and s is a palindrome, the locked stub code will print The
# word, s, is a palindrome; otherwise, it will print The word, s, is not a
# palindrome
...
class Solution
  ...
  def push_character(chr)
    @stack.push(chr)
  end

  def enqueue_character(chr)
    @queue.push(chr)
  end
