 ...
 *  Description : A single line of text containing one or more space-separated
 *  words.
 *
 *  Output Format
 *
 ...
 *  1. We printed the literal string Hello, World! using the code provided in
 *  the editor.
 *
 *  The value of parameterVariable passed to our main function in this Sample
 *  Case was Welcome to 10 Days of JavaScript!. We then passed our variable to
 *  console.log, which printed the contents of parameterVariable.
 */

/**
 * A line of code that prints "Hello, World!" on a new line is provided in the
 * editor.
 * Write a second line of code that prints the contents of 'parameterVariable'
 * on a new line.
 *
 * Parameter:
