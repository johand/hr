...
# clouds. Some of the clouds are thunderheads and others are cumulus. The
# player can jump on any cumulus cloud having a number that is equal to the
# number of the current cloud plus 1 or 2.

# The player must avoid the thunderheads. Determine the minimum number of jumps
# it will take to jump from the starting postion to the last cloud. It is
...
# these two paths: 0 -> 2 -> 4 -> 6 or 0 -> 2 -> 3 -> 4 -> 6. The first path
