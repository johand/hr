...
# It can be treated like a variable, which can be assigned to another variable,
# passed as an argument to a method.

# * Remembers the value of variables no longer in scope.

# It remembers the values of all the variables that were in scope when the
# function was defined.

# It is then able to access those variables when it is called even if they are
...
# In this example, the variable x, which is closed within the lambda y,
# remembers its values. Here, x remembers its value as 1.
