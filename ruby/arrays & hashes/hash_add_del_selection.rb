...
# For destructive selection and deletion, we can use keep_if and delete_if as
# seen in Array-Selection
...
# For non-destructive selection or rejection, we can use select, reject, and
# drop_while similar to Array-Selection

# In this challenge, a hash object called hackerrank is already created. You
# have to add
