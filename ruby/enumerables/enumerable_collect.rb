...
# methods return a new collection while former returns the original collection,
# irrespective of whatever happens inside the block.
...
# ROT13 cipher system; returning an array containing the final messages.
